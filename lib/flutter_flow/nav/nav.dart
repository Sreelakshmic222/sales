...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
  ...
  routes: [
    ...
    FFRoute(
      name: 'Sales',
      path: '/sales',
      builder: (context, params) => const SalesWidget(),
    ),
    FFRoute(
      name: 'Product',
      path: '/product',
    ...
    FFRoute(
      name: 'NewQuotation',
      path: '/newquotation',
      builder: (context, params) => const NewQuotationWidget(),
    ),

    FFRoute(
      name: 'quotations',
      path: '/quotations',
      builder: (context, params) => const QuotationsWidget(),
    ),
    FFRoute(
      name: 'addproduct',
      path: '/addproduct',
    ...
    FFRoute(
      name: 'salesteams',
      path: '/salesteams',
      builder: (context, params) => const SalesteamsWidget(),
    ),
    FFRoute(
      name: 'customers',
      path: '/customers',
    ...
    //   name: 'webcheckout',
    //   path: '/webcheckout',
    //   builder: (context, params) => const WebcheckoutWidget(),
    // )
